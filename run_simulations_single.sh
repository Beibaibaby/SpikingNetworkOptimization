...
#SBATCH --mem=50GB
#SBATCH --output=/gpfs/data/doiron-lab/draco/out_dave_12/dave_demo.%j.txt
#SBATCH --error=/gpfs/data/doiron-lab/draco/out_dave_12/dave_demo.%j.err
